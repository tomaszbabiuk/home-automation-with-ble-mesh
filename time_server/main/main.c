...
static esp_ble_mesh_time_state_t time_state;
...
static esp_ble_mesh_time_srv_t time_server = {
    .rsp_ctrl.get_auto_rsp = ESP_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = ESP_BLE_MESH_SERVER_AUTO_RSP,
    .state = &time_state
};
...
static void example_ble_mesh_time_server_cb(esp_ble_mesh_time_scene_server_cb_event_t event,
                                            esp_ble_mesh_time_scene_server_cb_param_t *param) {
    ESP_LOGE(TAG, "TODO... should process time requests here");
}
...
void app_main(void)
{
    ...
    bt_mesh_set_device_name("TIME-SERVER");
}
